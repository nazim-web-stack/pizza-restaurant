        ...
        <div className="carousel-item active" style={{
          ...
          <div className="container" style={{ paddingTop: '100px' }}>
            <div className="row"><div className="col-lg-7">
              ...
              <a href="#" style={{ background: '#f5a623', color: '#fff', padding: '14px 35px', borderRadius: '30px', fontWeight: 700, marginRight: '12px', textDecoration: 'none' }}>Order Now</a>
              <a href="#" style={{ border: '2px solid rgba(255,255,255,0.5)', color: '#fff', padding: '12px 30px', borderRadius: '30px', fontWeight: 700, textDecoration: 'none' }}>View Menu</a>
            </div></div>
          </div>
        </div>
